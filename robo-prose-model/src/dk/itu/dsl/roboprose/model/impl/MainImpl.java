 ...
 * </p>
 * <ul>
 *   <li>{@link dk.itu.dsl.roboprose.model.impl.MainImpl#getActions <em>Actions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MainImpl extends MinimalEObjectImpl.Container implements Main {
	...
	protected EClass eStaticClass() {
		return RoboprosePackage.Literals.MAIN;
	}
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectContainmentEList<Action>(Action.class, this, RoboprosePackage.MAIN__ACTIONS);
		}
		return actions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RoboprosePackage.MAIN__ACTIONS:
