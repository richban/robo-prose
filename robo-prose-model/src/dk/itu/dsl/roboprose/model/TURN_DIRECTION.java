 ...
 * @generated
 */
public enum TURN_DIRECTION implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final TURN_DIRECTION[] VALUES_ARRAY =
		new TURN_DIRECTION[] {
			LEFT,
			RIGHT,
		};
	 ...
	 * @generated
	 */
	public static final List<TURN_DIRECTION> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static TURN_DIRECTION get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TURN_DIRECTION result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TURN_DIRECTION getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TURN_DIRECTION result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TURN_DIRECTION get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TURN_DIRECTION(int value, String name, String literal) {
		this.value = value;
		this.name = name;
